...
public class OperaterEx2 {	
	...
	// main method 자동 완성
	// - class 만들 때 [] public static void main(String[] args)에 체크
	// - main -> ctrl + spacebar 
	public static void main(String[] args) {
		 ...
		 * 
		 * 전위 연산 : ++a, --a
		 * - 다른 연산보다 먼저 a를 증가 또는 감소 시킴 (괄호 다음, 거의 최우선)
		 * 
		 * 후위 연산 : a++, --a
		 * - 다른 연산을 모두 수행한 후 a를 증가 또는 감소 시킴 (거의 마지막)
		 * 
		 * */
		...
		// 비교 연산자 : ==  !=  >  <  >=  <=  (6종)
		// - 복합 기호에서 등호(=)는 항상 오른쪽
		// - 비교 연산의 결과는 항상 논리형 (true or false)
		...
		// 짝수 검사 = 2의 배수 (해당 숫자로 나누어서 나머지가 0인지 확인)
