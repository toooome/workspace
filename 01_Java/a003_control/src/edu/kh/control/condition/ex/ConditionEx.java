...
public class ConditionEx {
	...
	public void ex5() {
		...
		if(input <= 13) {
			result = "어린이";
		} else if(input <= 19) { // 13 이하가 아니라고 넘어왔으니 없다고 치고 간단하게
			result = "청소년";
		} else {
			result = "성인";
		}
	...
	public void ex7() {
		...
		if(age < 0 || age > 100) {
			...
			} else if (height < 140.0) { // 140 입력해도 자동 형변환 됨
				result = "적정 키가 아닙니다.";
