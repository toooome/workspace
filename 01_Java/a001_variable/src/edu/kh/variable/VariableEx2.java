...
public class VariableEx2 {
	...
	public static void main(String[] args) {
		...
		// 변수 선언 : 메모리에 값을 저장할 공간을 할당(생성)
		
		// 자료형 : 변수의 종류를 지정(크기, 형식별로 다름)
	...
	//  자료형  변수명
		boolean booleanData; 
		// 논리형 데이터(true or false)를 저장할 공간
		...
		// int : -14, 0, 29 (기본 정수 표기법)
		
		// long : 2147483648L, 0L, -14l 
		// (l, L 명시. 가독성을 위해 보편적으로 L을 사용)
		
		// double : 14.29, -0.54, 0.0 
		// (기본 실수 표기법, 모두 실수 형태로 작성. 0도 0.0으로 표기)
		
		// float : 14.29f, -0.54f, 0.0F (f, F 명시)
		
		// boolean : true, false (2개)
		
		// char : '최', '정', 'H', 'R' (''를 사용하여 표기)
		//		  0 ~ 65535 사이 정수 표현 가능
		
		// byte, short : -14, 0, 29 (int와 표기법이 동일) 
		// Q 왜 int와 표기법이 같을까? 
		// -> byte, short는 옛날 코드와의 호환을 위해 만들어진 자료형으로
		//    사용 빈도가 낮아 별도의 리터럴 표기법을 제작 X 
		//    (임시로 int 표기법을 사용)
		...
		float number4 = 14.29F;
		// F을 붙이지 않으면 double 표기법으로 인식되어
		// 14.29가 double로 해석됨
		// (float형 변수에 저장할 수 없어서 오류 발생)
		
		byte number5 = 100;	
		short number6 = 200;
		// byte, short는 int 표기법을 사용 
		...
		// 출력 시 리터럴 표기법은 생략된다. (F or L 등은 출력되지 않음)
