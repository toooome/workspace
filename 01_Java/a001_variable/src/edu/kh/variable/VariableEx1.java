...
public class VariableEx1 {
	...
	public static void main(String[] args) {
		...
		// ctrl + shift + f : 코드 정렬 (길어지거나 많아지면 제대로 적용되지 않으므로 너무 맹신하지 말것)
		...
		System.out.println("[변수 사용 O인 경우]");
		...
		// 변수란? 
		// - 메모리(RAM)에 값을 기록하는 공간(상자)
		// - 공간에 기록되는 값(Data)이 변할 수 있어서 변수라고 함
		
		// 변수 사용의 장점
		// 1. 코드 작성이 용이함 (편리함, 쉽다, 코드 길이 감소)
		// 2. 가독성 향상 (읽기 편함)
		// 3. 재사용성의 증가 
		// 4. 유지 및 보수 용이, 향상 (수정이 쉬움)
